  ...
  return (
    <header className={styles.header}>
      <div className={`${styles.header_top_container} container`}> 
        ...
        <Link className={styles.head_links} to='/profilepage'><i className="fas fa-user"></i> Profile</Link>
        <Link className={styles.head_links} to='/places'><i className="fas fa-map-marker-alt"></i> Places</Link>
